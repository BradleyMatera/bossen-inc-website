...
<section class="hero">
    ...
    <section class="trust-bar">
      <div class="trust-bar-inner">
        <div class="trust-item">
          <strong>Active Interstate Carrier</strong>
          FMCSA registered
        </div>
        <div class="trust-item">
          <strong>USDOT 3358683</strong>
          MC-1075161
        </div>
        <div class="trust-item">
    ...
    <section class="section">
      <div class="container">
        <h2 class="section-title">What BOSSEN INC Does</h2>
        <p class="section-subtitle">One local company for commercial trucks, trailers, drivers, and fleets. Every service below is clearly marked so you know what we can handle and how to reach us.</p>
    ...
    <section class="section section-alt">
      <div class="container">
        <h2 class="section-title">Stranded? Here Is What to Do</h2>
        <p class="section-subtitle">If you are stuck on the road, the fastest thing you can do is call. We will walk you through the rest.</p>
        ...
        <div class="roadside-flow">
          <div class="roadstep">
            ...
            <div>
              ...
              <p>Call the number below and tell us your location, truck/trailer type, and what happened. Do not use the form for emergencies.</p>
            </div>
          </div>
          <div class="roadstep">
            ...
            <div>
              ...
              <p>No-start, air leak, brake issue, lighting, trailer damage, or something else. The more detail, the better.</p>
            </div>
          </div>
          <div class="roadstep">
            <div class="roadstep-number">3</div>
            <div>
              <h3>Stay safe and send photos</h3>
              <p>Pull off the road safely, turn on hazards, and text photos if you can. We will tell you what we can do from there.</p>
            </div>
          </div>
        </div>

        <p class="text-center">
          <a class="btn btn-danger btn-large" href="tel:+10000000000" data-placeholder="true">Call Roadside Service</a>
        </p>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <h2 class="section-title">Why Drivers Call BOSSEN INC</h2>
        <div class="content">
          <ul>
            <li><strong>Active interstate carrier.</strong> We are registered with FMCSA under USDOT 3358683 and MC-1075161.</li>
            <li><strong>Real mechanical and transportation experience.</strong> We understand trucks because we work on them and move freight with them.</li>
            <li><strong>Honest communication.</strong> We tell you what is wrong, what it costs, and how long it will take before we start.</li>
            <li><strong>Driver respect.</strong> We know your schedule is your paycheck. We do not waste your time.</li>
            <li><strong>Local Rockford base.</strong> Northern Illinois is where we operate and where we plan to grow.</li>
          </ul>

          <div class="placeholder">
            <strong>Placeholder:</strong> Phone number, hours, exact address, and service area need to be confirmed with Paul before this site goes live.
          </div>
        </div>
      </div>
    </section>
